...
type ToasterToast = ToastProps & {
  ...
  variant?: "default" | "destructive"; // Include variant in ToasterToast
};
...
// useToast hook to expose toast functionality
function useToast() {
